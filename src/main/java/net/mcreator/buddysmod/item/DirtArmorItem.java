...
public abstract class DirtArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("block.grass.break")), () -> Ingredient.of(ItemTags.create(ResourceLocation.parse("minecraft:dirt"))),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("buddysmod:dirtarmor"))), 1f, 0f);
			registerHelper.register(ResourceLocation.parse("buddysmod:dirt_armor"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public DirtArmorItem(ArmorItem.Type type, Item.Properties properties) {
