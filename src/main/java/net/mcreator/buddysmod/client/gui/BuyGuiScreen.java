...
public class BuyGuiScreen extends AbstractContainerScreen<BuyGuiMenu> implements BuddysmodModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("buddysmod:textures/screens/buy_gui.png");
